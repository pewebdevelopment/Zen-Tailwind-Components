    ...
    >
      ...
      >
        ...
        <aside
          ...
          x-ref="sidebar"
          @keydown.escape="
            window.innerWidth <= 1024 ? (isSidebarOpen = false) : ''
          "
          tabindex="-1"
          class="
            fixed
            ...
            border-r
            lg:static
            dark:border-indigo-800 dark:bg-darker
            focus:outline-none
          "
        >
          <!-- Mini column -->
            ...
            >
              ...
              <button
                ...
                class="
                  ...
                  dark:hover:text-light dark:hover:bg-indigo-700 dark:bg-dark
                ...
                >
                  <a
                    ...
                    class="
                      ...
                      transition-colors
                      hover:bg-gray-100
                      dark:text-light dark:hover:bg-indigo-600
                    "
                  >
                    Your Profile
                  </a>
        ...
        <main class="flex-1">
          <div
            ...
            "
          >
            <h1 class="mb-4 text-2xl font-semibold text-center md:text-3xl">
              Mini + One Columns Sidebar
            </h1>
            <div class="mb-4">
              <div
                  ...
                  <button
                    ...
                    :class="{
                      'border-gray-900 text-gray-900 dark:border-indigo-500 dark:text-indigo-100':
                        !isDark,
                      'text-gray-500 dark:text-indigo-500': isDark,
                    }"
                  >
                    <span>
                      <svg
          ...
          <div class="flex flex-col h-screen">
            ...
            <div
              class="
                ...
                text-gray-400
                border-b
                dark:border-indigo-800 dark:focus-within:text-light
