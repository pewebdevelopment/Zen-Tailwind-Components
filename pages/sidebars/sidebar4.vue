...
<template>
  <div>
    ...
    <!-- CTA button & Announcement Sidebar  -->
          ...
          <div class="flex items-center mb-3">
            <span
              class="
                ...
                py-0.5
                rounded
                dark:bg-orange-200 dark:text-orange-900
              "
              >Beta</span
            >
            <button
              ...
              class="
                ...
                h-6
                w-6
                dark:bg-blue-900 dark:text-blue-400 dark:hover:bg-blue-800
              "
